...
Name: Hayden LeBaron
Github Username: HaydenLeBaron
Bio: Functional programming enthusiast. Interested in type theory, formal logic, and Byzantium.
Location: Salt Lake City, Utah (willing to relocate world-wide for the right opportunity)
Email: me@haydenlebaron.com
LinkedIn: www.linkedin.com/in/hayden-lebaron-740074163
...
**about**: "A Lean 4 eDSL for writing declarative, correct-by-construction packing lists for user defined expeditions (e.g. walking the Camino, hiking the CDT, dressing for a wedding)"

**tags**: functional-programming, theorem-proving, edsl, formal-verification, dependant-typing, programming-language

**repo link**: https://github.com/HaydenLeBaron/provably-packed

**README url**: https://github.com/HaydenLeBaron/provably-packed/blob/main/README.md
...
**about**: "A relative pitch/rhythm based embedded DSL built on Racket and Alda."

**tags**: programming-language, racket, music-composition, declarative-language, edsl

**repo link**: https://github.com/HaydenLeBaron/arezzo

**README url**: https://github.com/HaydenLeBaron/arezzo/blob/main/README.md

### funxychat

**technologies**: ["OCaml"]

**about**: "(* "An anonymous CLI-based chat service you can trust against your better judgment.™" *)"

**repo link**: https://github.com/HaydenLeBaron/funxychat

**README url**: https://github.com/HaydenLeBaron/funxychat/blob/main/README.md


### sweaty tictactoe

**technologies**: ["Haskell", "Scotty"]

**tags**: haskell, http-server, cli, esports, honor, high-stakes

**about**: "Tic-tac-toe for tryhards. Play for glory."

**repo link**: https://github.com/HaydenLeBaron/sweaty-tictactoe

**README url**: https://github.com/HaydenLeBaron/sweaty-tictactoe/blob/main/README.md
...
**about**: A quantified-self project that displays charts representing location data from Google Takeout. The user inputs a file path for downloaded JSON Google Takeout location data and the coordinates for places of interest to see an analysis of time spent at the locations of interest.

**tags**: data-analysis, quantified-self, python, jupyter-notebook

**repo link**: https://github.com/tyguy-1122/qs-location-dashboard

**README url**: https://github.com/tyguy-1122/qs-location-dashboard/blob/main/README.md


### Δy

**technologies**: ["Flutter", "Dart", "Firebase", "Cloud Firestore", "Google Cloud Platform"]

**about**: A scrum-inspired personal productivity app for data-nerds with goals.

**tags**: android productivity quantified-self scrum flutter

**repo link**: https://github.com/delta-y-app/delta-y-releases
